...
function generateKeyword() {
  var keywords = [
    "好きな映画", "旅行", "スポーツ", "音楽", "好きな食べ物", "きのこ・たけのこ", "好きな飲み物", "好きな国", "嫌いな教科", "好きなユーチューバー", "好きなおやつ", "嫌いな教科", "なりたい職業(なりたかった職業)", "好きなゲーム", "自分の趣味", "好きな本", "好きなアーティスト/バンド", "好きな動物", "好きな季節", "好きな花", "好きな車のメーカー", "好きなテレビ番組", "好きな言語", "休日の過ごし方", "好きなイベント", "好きなスポーツチーム", "好きな料理", "好きな祝日", "好きなアート作品", "好きな科学分野", "好きな企業のタイプ", "インターネットの活用方法", "好きな時代", "好きな人物の特徴", "好きな歴史人物", "好きな言葉/名言", "フィットネスアクティビティ", "好きな家具", "好きな楽器", "好きなテーマパーク", "好きな色", "好きなネットミーム", "好きな調味料", "好きなイヤホン", "好きな演説","欲しいペット","好きな祭り"
  ];
